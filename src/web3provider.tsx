...
const config = createConfig(
  getDefaultConfig({
    ...
    // Optional App Info
    appDescription: "A modern short-form video platform with Zora CoinV4 integration",
    appUrl: "https://clipcoin.app", // your app's url
    appIcon: "/vite.svg", // your app's icon
  }),
);
